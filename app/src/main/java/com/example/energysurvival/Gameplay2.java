...
public class Gameplay2 extends AppCompatActivity {
    ...
    private ImageButton btnSolar, btnWind, btnOil, btnCoal, btnBiomass;
    private TextView tvMoney, tvNature, tvEnergy, tvTimer;
    private int money = 60000, nature = 3000 , energy = 0;
    private String pressed;
    private long timerGame = 60000;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvTimer = findViewById(R.id.tv_timer2);
        btnInfo2 = findViewById(R.id.btn_info2);
        infoDialog2 = new Dialog(this);
        infoDialog2.getWindow().setBackgroundDrawable(new ColorDrawable(android.graphics.Color.TRANSPARENT));
    ...
    public void handler (String status){
        ...
        else if (energy >= 500 && timerRunning){
            goToWin();
        }
        else{
    ...
    public void goToWin(){
        ...
        intent.putExtra("lv2",totalScore);
    ...
    public void showPopUp2(){
        ...
        infoDialog2.setContentView(R.layout.info_popup2);
        btnclose = (ImageButton)infoDialog2.findViewById(R.id.btn_close2);
