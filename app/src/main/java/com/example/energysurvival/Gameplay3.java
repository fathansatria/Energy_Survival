...
public class Gameplay3 extends AppCompatActivity {
    ...
    private ImageButton btnSolar, btnWind, btnOil, btnCoal, btnBiomass, btnGeotermal;
    private TextView tvMoney, tvNature, tvEnergy, tvTimer;
    private int money = 75000, nature = 5000 , energy = 0;
    private String pressed;
    private long timerGame = 90000;
    private CountDownTimer c1;
    private boolean timerRunning;
    private String account;
    private ImageButton btnInfo3;
    Dialog infoDialog3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gameplay3);
        ...
        btnBiomass = findViewById(R.id.btn_biomass);
        tvEnergy = findViewById(R.id.tv_energy);
        btnGeotermal = findViewById(R.id.btn_geothermal);
        tvNature = findViewById(R.id.tv_nature);
        tvTimer = findViewById(R.id.tv_timer3);
        btnInfo3 = findViewById(R.id.btn_info3);
        infoDialog3 = new Dialog(this);
        infoDialog3.getWindow().setBackgroundDrawable(new ColorDrawable(android.graphics.Color.TRANSPARENT));
        ...
        btnBiomass.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                soundPop();
                pressed = "biomass";
        ...
        btnGeotermal.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                soundPop();
                pressed = "geotermal";
    ...
    public void handler (String status){
        ...
        else if(status.equals("geotermal")){
        ...
        else if (energy >= 700 && timerRunning){
            goToWin();
        }
        else{
    ...
    public void goToWin(){
        ...
        intent.putExtra("lv3",totalScore);
    ...
    public void showPopUp3(){
        ...
        infoDialog3.setContentView(R.layout.info_popup3);
        btnclose = (ImageButton)infoDialog3.findViewById(R.id.btn_close3);
